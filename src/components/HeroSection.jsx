                    ...
                    <div className="banner-letters-wrap">
                        <div className="banner-letters-row">
                            <div className="banner-letters-flex">
                                <div className="single-banner-letter _01"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/692090a0dce81b6c2e6d25a7_V.svg" loading="lazy" alt="Banner Letter" className="banner-letter _01" /></div>
                                <div className="single-banner-letter _02"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/692090a090ec532a71755ced_I-1.svg" loading="lazy" alt="Banner Letter" className="banner-letter _02" /></div>
                                <div className="single-banner-letter _03"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/692090a01adbcc362b61bb48_S.svg" loading="lazy" alt="Banner Letter" className="banner-letter _03" /></div>
                                <div className="single-banner-letter _04"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/692090a090ec532a71755ced_I-1.svg" loading="lazy" alt="Banner Letter" className="banner-letter _04" /></div>
                                ...
                                <div className="single-banner-letter _05"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/692090a05c4b8bbb901ff9ce_N.svg" loading="lazy" alt="Banner Letter" className="banner-letter _05" /></div>
                            </div>
                        </div>
                    </div>
