            ...
            <div className="container navbar-container">
                <div className="navbar-wrap">
                    <div className="navbar-flex-wrap">
                        <div className="nav-flex-left"><a href="/" aria-current="page" className="main-logo-wrap w-nav-brand w--current"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/69429298f40374aa1883affa_Main-Logo.svg" loading="lazy" alt="" className="main-logo"/></a>
                            <div
                                className="nav-links-wrapper">
                                <div className="nav-links-flex">
                                    <a href="/" aria-current="page" className="single-nav-link w-inline-block w--current">
                                        <div>Home</div>
                                    </a>
                                    <a href="/about-us" className="single-nav-link w-inline-block">
                                        <div>About Us</div>
                                    </a>
                                    <a href="/services" className="single-nav-link w-inline-block">
                                        <div>Services</div>
                                    </a>
                                    <a href="/projects" className="single-nav-link w-inline-block">
                                        <div>Works</div>
                                    </a>
                                    <a href="/contact-us" className="single-nav-link w-inline-block">
                                        <div>Contact</div>
                                    </a>
                                </div>
                        </div>
                    ...
                    <div className="nav-flex-right">
                        <div className="nav-right-flex">
                            <div className="nav-button-wrap">
                                <a data-wf--primary-button--variant="blue" href="/services" className="primary-button w-variant-4c2497dc-c520-3049-f2ee-2eb4bb579d66 w-inline-block">
                                    <div className="primary-button-flex">
                                        ...
                                        <div className="primary-button-arrow-wrapper w-variant-4c2497dc-c520-3049-f2ee-2eb4bb579d66">
                                            <div className="primary-button-arrow-wrap"><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/6910991e7df760b9063f4b51_Button-Arrow-Blue.svg" loading="lazy" alt="Arrow" className="primary-button-arrow" /><img src="https://cdn.prod.website-files.com/68dbb9a72b91c794d0cdd10c/6910991e7df760b9063f4b51_Button-Arrow-Blue.svg"
                                                    ...
                                                    <div className="navigation-content-wrapper">
                                                        <div className="navigation-contents">
                                                            <div className="navigation-links-flex">
                                                                <a href="/" aria-current="page" className="single-navigation-links w-inline-block w--current">
                                                                ...
                                                                <a href="/about-us" className="single-navigation-links w-inline-block">
                                                                    <div className="navigation-inline-wrap">
                                                                        <div className="navigation-text-flex">
                                                                ...
                                                                <a href="/services" className="single-navigation-links w-inline-block">
                                                                    <div className="navigation-inline-wrap">
                                                                        <div className="navigation-text-flex">
                                                                ...
                                                                <a href="/projects" className="single-navigation-links w-inline-block">
                                                                    <div className="navigation-inline-wrap">
                                                                        <div className="navigation-text-flex">
                                                            ...
                                                            <div className="navigation-button-wrapper">
                                                                <a href="/contact-us" className="navigation-button w-inline-block">
